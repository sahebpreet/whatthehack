...
public class ProductSubscriptionDaoImpl implements ProductSubscriptionDao{
	...
	public boolean edittSubscription(Product_subscriptions prodSub) {
		...
		String updateProd ="update product_subscriptions duration=" + prodSub.getDuration() + ",laset_delivery_date="+ prodSub.getLast_delivery_date() + ",subscription_date=" + prodSub.getSubscription_date() +",quantity=" + prodSub.getQuantity() +",next_delivery_date=" + prodSub.getNext_delivery_date() + "where uid=" + uid + " and pid=" + pid;
